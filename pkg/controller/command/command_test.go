...
func TestNew(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		km.EXPECT().ExportPubKeyBytes(kid).Return([]byte(`public key`), kms.KeyType(""), nil)
	...
	t.Run("Empty key", func(t *testing.T) {
		...
		km := NewMockKeyManager(ctrl)
		km.EXPECT().Get(kid).Return(nil, nil)
		km.EXPECT().ExportPubKeyBytes(kid).Return(nil, kms.KeyType(""), nil)
	...
	t.Run("KMS export pub key failed", func(t *testing.T) {
		...
		km := NewMockKeyManager(ctrl)
		km.EXPECT().Get(kid).Return(nil, nil)
		km.EXPECT().ExportPubKeyBytes(kid).Return(nil, kms.KeyType(""), errors.New("internal error"))
